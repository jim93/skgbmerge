...
@ -I/home/j2/AndroidDev/GBSidekick/skgbmerge/KernelC/arch/arm/include
@ -Iinclude -Iarch/arm/mach-s5pv210/include -Iarch/arm/plat-s5p/include
@ -Iarch/arm/plat-samsung/include -iprefix
@ /opt/toolchains/arm-2009q3/bin/../lib/gcc/arm-none-eabi/4.4.1/ -isysroot
@ /opt/toolchains/arm-2009q3/bin/../arm-none-eabi -D__USES_INITFINI__
@ -Dlinux -D__KERNEL__ -D__LINUX_ARM_ARCH__=7 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(bounds) -DKBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem
@ /opt/toolchains/arm-2009q3/bin/../lib/gcc/arm-none-eabi/4.4.1/include
...
.LASF49:
	.ascii	"/home/j2/AndroidDev/GBSidekick/skgbmerge/KernelC\000"
.LASF28:
